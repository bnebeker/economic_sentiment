...
class TrendReqDaily(object):
    ...
    def _get_data(self, url, method=GET_METHOD, trim_chars=0, **kwargs):
        ...
        if method == TrendReqDaily.POST_METHOD:
    ...
    def _tokens(self):
        ...
        widget_dict = self._get_data(
            url=TrendReqDaily.GENERAL_URL,
            method=TrendReqDaily.GET_METHOD,
    ...
    def interest_over_time(self):
        ...
        req_json = self._get_data(
            url=TrendReqDaily.INTEREST_OVER_TIME_URL,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
    ...
    def interest_by_region(self, resolution='COUNTRY', inc_low_vol=False,
        ...
        # parse returned json
        req_json = self._get_data(
            url=TrendReqDaily.INTEREST_BY_REGION_URL,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
    ...
    def related_topics(self):
        ...
        for request_json in self.related_topics_widget_list:
            ...
            req_json = self._get_data(
                url=TrendReqDaily.RELATED_QUERIES_URL,
                method=TrendReqDaily.GET_METHOD,
                trim_chars=5,
    ...
    def trending_searches(self, pn='united_states'):
        ...
        req_json = self._get_data(
            url=TrendReqDaily.TRENDING_SEARCHES_URL,
            method=TrendReqDaily.GET_METHOD,
            **self.requests_args
        )[pn]
    ...
    def today_searches(self, pn='US'):
        ...
        req_json = self._get_data(
            url=TrendReqDaily.TODAY_SEARCHES_URL,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
            params=forms,
            **self.requests_args
    ...
    def top_charts(self, date, hl='en-US', tz=300, geo='GLOBAL'):
        ...
        # make the request and parse the returned json
        req_json = self._get_data(
            url=TrendReqDaily.TOP_CHARTS_URL,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
    ...
    def suggestions(self, keyword):
        ...
        req_json = self._get_data(
            url=TrendReqDaily.SUGGESTIONS_URL + kw_param,
            params=parameters,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
            **self.requests_args
    ...
    def categories(self):
        ...
        req_json = self._get_data(
            url=TrendReqDaily.CATEGORIES_URL,
            params=params,
            method=TrendReqDaily.GET_METHOD,
            trim_chars=5,
            **self.requests_args
